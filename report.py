...
class ReportClass:
    def __init__(self, root):
        ...
        # ===title=====
        title = Label(self.root, text="View Student Results",font=("times new roman", 18, "bold"), bg="orange", fg="#262626")
        ...
        txt_search=Entry(self.root, textvariable=self.var_search ,font=("times new roman", 20),bg="lightyellow").place(x=520,y=100, width=150)
        btn_search=Button(self.root, text="Search", font=("times new roman", 15, "bold"),bg="#03a9f4", fg="white", cursor="hand2", command=self.search).place(x=680, y=100, width=100, height=35)
        btn_clear=Button(self.root, text="Clear", font=("times new roman", 15, "bold"),bg="gray", fg="white", cursor="hand2", command=self.clear).place(x=800, y=100, width=100, height=35)
