...
class Register:
    def __init__(self, root):
        ...
        Label(frame1, text="First Name", font=("Georgia", 13, "bold"), bg="#FFFBF6", fg="#444444").place(x=60, y=115)
        Entry(frame1, textvariable=self.var_fname, font=("Georgia", 15), bg="lightgray").place(x=60, y=155, width=280)

        Label(frame1, text="Last Name", font=("Georgia", 13, "bold"), bg="#FFFBF6", fg="#444444").place(x=415, y=115)
        Entry(frame1, textvariable=self.var_lname, font=("Georgia", 15), bg="lightgray").place(x=415, y=155, width=280)

        Label(frame1, text="Contact No.", font=("Georgia", 13, "bold"), bg="#FFFBF6", fg="#444444").place(x=60, y=200)
        Entry(frame1, textvariable=self.var_contact, font=("Georgia", 15), bg="lightgray").place(x=60, y=235, width=280)

        Label(frame1, text="Email", font=("Georgia", 13, "bold"), bg="#FFFBF6", fg="#444444").place(x=415, y=200)
        Entry(frame1, textvariable=self.var_email, font=("Georgia", 15), bg="lightgray").place(x=415, y=235, width=280)

        Label(frame1, text="Security Question", font=("Georgia", 13, "bold"), bg="#FFFBF6", fg="#444444").place(x=60, y=280)
        ...
        bg="#FFFBF6", fg="#444444").place(x=415, y=280)
        Entry(frame1, textvariable=self.var_answer, font=("Georgia", 15), bg="lightgray").place(x=415, y=315, width=280)

        Label(frame1, text="Password", font=("Georgia", 13, "bold"), bg="#FFFBF6", fg="#444444").place(x=60, y=360)
        Entry(frame1, textvariable=self.var_pass, font=("Georgia", 15), bg="lightgray", show="*").place(x=60, y=395, width=280)

        Label(frame1, text="Confirm Password", font=("Georgia", 13, "bold"), bg="#FFFBF6", fg="#444444").place(x=415, y=360)
        ...
        Checkbutton(frame1, text="I agree to the Terms & Conditions", variable=self.var_chk,
                    font=("Georgia", 13), bg="#FFFBF6", onvalue=1, offvalue=0).place(x=60, y=440)
