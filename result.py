...
class ResultClass:
    def __init__(self, root):
        ...
        # ===title=====
        title = Label(self.root, text="Add Student Results",font=("times new roman", 18, "bold"), bg="orange", fg="#262626")
        title.place(x=10, y=15, width=1280, height=50)
        ...
        # ===widgets=====
        lbl_select=Label(self.root, text="Select Student",font=("times new roman", 15, "bold"),bg="white").place(x=50,y=100)
        lbl_name=Label(self.root, text="Name",font=("times new roman", 15, "bold"),bg="white").place(x=50,y=160)
        lbl_course=Label(self.root, text="Course",font=("times new roman", 15, "bold"),bg="white").place(x=50,y=220)
        lbl_marks_ob=Label(self.root, text="Marks obtained",font=("times new roman", 15, "bold"),bg="white").place(x=50,y=280)
        lbl_full_marks=Label(self.root, text="Full Marks",font=("times new roman", 15, "bold"),bg="white").place(x=50,y=340)
        ...
        #===button===
        btn_add=Button(self.root, text="Submit", font=("times new roman", 15), bg="green", fg="white", activebackground="green", cursor="hand2", command=self.add).place(x=300, y=420, width=120, height=35)
        btn_clear=Button(self.root, text="Clear", font=("times new roman", 15), bg="gray",fg="white", activebackground="gray", cursor="hand2", command=self.clear).place(x=430, y=420, width=120, height=35)


        #===image===
        self.bg_image = Image.open("IMAGES/Screenshot 2025-05-13 110156.png")
